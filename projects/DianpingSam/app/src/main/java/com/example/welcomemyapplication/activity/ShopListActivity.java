...
import com.example.welcomemyapplication.adapter.SearchMainAdapter;
import com.example.welcomemyapplication.adapter.SearchMoreAdapter;
...
//                    ThreadPoolUtils.execute(new HttpGetThread(hand, url));
                    listBottemFlag = false;
                     ...
                     Toast.makeText(ShopListActivity.this, "listBottom", Toast.LENGTH_SHORT).show();
            }
        });
...
//        ThreadPoolUtils.execute(new HttpGetThread(hand, url));
    ...
    Handler hand = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            if (msg.what == 404) {
                Toast.makeText(ShopListActivity.this, "404", Toast.LENGTH_SHORT).show();
                listBottemFlag = true;
            } else if (msg.what == 100) {
                Toast.makeText(ShopListActivity.this, "100", Toast.LENGTH_SHORT).show();
                listBottemFlag = true;
